...
--
CREATE DATABASE IF NOT EXISTS `arpi_database` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `arpi_database`;
...
INSERT INTO `leave_data` (`BB_No`, `Type`, `Start_Date`, `Duration`, `Remarks`) VALUES
('bvjbj', 'sick', '2017-07-04', '2', '');
...
ALTER TABLE `leave_data`
  ADD PRIMARY KEY (`BB_No`,`Type`,`Start_Date`,`Duration`,`Remarks`);
